...
def get_workflow_runs(token: str):
    params = {"Accept": "application/vnd.github+json",
              "Authorization": f"token {token}",
              "X-GitHub-Api-Version": "2022-11-28",
              "branch": "patchworks-ci",
              "event": "schedule"}
    url = "https://api.github.com/repos/ewlu/riscv-gnu-toolchain/actions/runs"
...
def main():
    ...
    runs = get_workflow_runs(args.token)
